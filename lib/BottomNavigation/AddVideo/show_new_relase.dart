...
class ShowNewRelease extends StatefulWidget {
  ShowNewRelease({Key? key}) : super(key: key);

  @override
  _ShowNewReleaseState createState() => _ShowNewReleaseState();
}
...
class _ShowNewReleaseState extends State<ShowNewRelease> {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              //playAudio(index);
                              print(audiosList[index].songUrl!);
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => FlickerDemoPlayer(
                                            fileName:
                                                audiosList[index].songUrl!,
                                            i: "2",
                                          )));
                              _isSelected(index);
                            },
  ...
  Future<File> _fileFromImageUrl(BuildContext contextw, index) async {
